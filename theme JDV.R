...
theme_jdv_dark <- function(base_size = 11, 
  ...
  theme_minimal(base_size = base_size,
                base_family = base_family) %+replace%
    theme(axis.title = element_text(face = 'bold', color = "#FFFFFF"),
          axis.title.x = element_text(vjust = -2, color = "#FFFFFF"),
          axis.title.y = element_text(vjust = 4, angle = 90, color = "#FFFFFF"),
          axis.text = element_text(color = "#FFFFFF"),
          legend.title = element_text(face = 'bold', color = "#FFFFFF"),
          legend.text = element_text(color = "#FFFFFF", size = 10),
          panel.grid.major = element_line(linetype = 'dotted', color = "grey42"), 
          panel.grid.minor = element_blank(),
          plot.background = element_rect(fill = "grey20"), 
          plot.title = element_text(size = 18, face = 'bold', 
                                    hjust = 0, vjust = 3, color = "#FFFFFF"), 
          plot.subtitle = element_text(hjust = 0, vjust = 2, color = "#FFFFFF"),
          plot.margin = unit(c(.8, .5, .5, 1), "cm"),
          strip.text = element_text(color = "#FFFFFF", face = "bold", size = 11),
